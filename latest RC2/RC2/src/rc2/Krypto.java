...
public class Krypto
{
	...
	public static String charArrayToString(char[][] inputNumbers, int stringLength)
	{
		...
		//angefÃ¼gte Nullen wieder entfernen:
	...
	public static char[][] splitString64(String input)
	{
		...
		{
			//Durchlaufen der 4-Char-BlÃ¶cke (64 Bit)
	...
	public static char[] splitLong(long input)
	{
		char[] chars = new char[4];
	       ...
	       char f = (char)(input & 0xffff);
                //long a= ((input >>> 16) & 0xffff);
                //long b= ((input >>> 32) & 0xffff);
                //long c= ((input >>> 48) & 0xffff);
