...
public class RC2
{
	...
	{
		//16-Bit-DatenstrÃ¶me in einzelne Variablen speichern:
	...
	//long a=(mixedData[2] & mixedData[3]);
       // long b= ~mixedData[3];
        //long c=(~mixedData[3] & mixedData[1]);
		//Weitere Operationen:
mixedData[0] = (char) ((mixedData[0] +(char)((char) (mixedData[2] & mixedData[3]) + (char) (~mixedData[3] & mixedData[1]) ) /*% 65536 */)% 65536 ); 
				
		//Linksrotation:
		mixedData[0] = Krypto.rotate('l', mixedData[0], s); 
		
		//Reihenfolge verÃ¤ndern:
	...
	public static String decrypt(String input, String key)
	{
		...
		//Array fÃ¼r entschlÃ¼sselte Werte:
		char[][] outChars= new char[inChars.length][4];
		for(int i=0; i < outChars.length; i++)
		{
			//VerschlÃ¼sselung jedes einzelnen Blocks:
	...
	public static void main(String[] args)
	{
		...
		long b = encryptLong(a, "ba");
                String s=encrypt("shereen","abcdef");
